...
3. git clone https://github.com/jaganthoutam/ansible-kubernetes-centos8 && cd ansible-kubernetes-centos8

4. Change the Master, worker nodes IP Adds in inventories/main.ini
